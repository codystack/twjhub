...
include "./components/navbar-alt-light.php";
?>
            ...
            <div class="container">
                <nav>
                    <div class="nav nav-tabs justify-content-center" id="nav-tab" role="tablist">
                        ...
                        <button class="nav-link" data-bs-toggle="tab" data-bs-target="#nav-withdrawal" type="button" role="tab" >Withdrawal</button>
                ...
                <div class="tab-content mt-60 lg-mt-40">
                    ...
                    <div class="tab-pane fade" id="nav-crypto" role="tabpanel" tabindex="0">
                    ...
                    <div class="tab-pane fade" id="nav-utilities" role="tabpanel" tabindex="0">
                    ...
                    <div class="tab-pane fade" id="nav-funding" role="tabpanel" tabindex="0">
                    ...
                    <div class="tab-pane fade" id="nav-withdrawal" role="tabpanel" tabindex="0">
